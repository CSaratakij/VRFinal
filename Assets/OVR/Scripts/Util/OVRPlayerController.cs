...
public class OVRPlayerController : MonoBehaviour
{
	...
	public virtual void UpdateMovement()
	{
		...
		{
			bool moveForward = Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.UpArrow) || (OVRInput.Get(OVRInput.Button.One, OVRInput.Controller.RTrackedRemote) && gearVRTouchpadAxis2D.y > 0.5f);
			bool moveLeft = Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.LeftArrow) || (OVRInput.Get(OVRInput.Button.One, OVRInput.Controller.RTrackedRemote) && gearVRTouchpadAxis2D.x < -0.5f);
			bool moveRight = Input.GetKey(KeyCode.D) || Input.GetKey(KeyCode.RightArrow) || (OVRInput.Get(OVRInput.Button.One, OVRInput.Controller.RTrackedRemote) && gearVRTouchpadAxis2D.x > 0.5f);
			bool moveBack = Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.DownArrow) || (OVRInput.Get(OVRInput.Button.One, OVRInput.Controller.RTrackedRemote) && gearVRTouchpadAxis2D.y < -0.5f);
