...
namespace VRStandardAssets.Utils
{
    ...
    public class VRInput : MonoBehaviour
    {
        ...
        private void CheckInput()
        {
			...
			if (Input.GetButtonDown("Fire1") || OVRInput.GetDown(OVRInput.Button.PrimaryIndexTrigger, OVRInput.Controller.LTrackedRemote) 
											 ...
											 || OVRInput.GetDown(OVRInput.Button.One, OVRInput.Controller.RTrackedRemote)) // Edit for GearVR Controller)
            {
				...
				m_MouseDownPosition = OVRInput.Get(OVRInput.Axis2D.PrimaryTouchpad, OVRInput.Controller.RTrackedRemote);
			...
			if (Input.GetButtonUp ("Fire1") || OVRInput.GetUp(OVRInput.Button.PrimaryIndexTrigger, OVRInput.Controller.LTrackedRemote) 
											|| OVRInput.GetUp(OVRInput.Button.PrimaryIndexTrigger, OVRInput.Controller.RTrackedRemote)
											|| OVRInput.GetUp(OVRInput.Button.One, OVRInput.Controller.LTrackedRemote)
										    || OVRInput.GetUp(OVRInput.Button.One, OVRInput.Controller.RTrackedRemote)) // Edit for GearVR Controller)
            {
				...
				m_MouseUpPosition = OVRInput.Get(OVRInput.Axis2D.PrimaryTouchpad, OVRInput.Controller.RTrackedRemote);
			...
			if (Input.GetButtonDown("Cancel") || OVRInput.GetDown(OVRInput.Button.Back, OVRInput.Controller.LTrackedRemote) 
